<form id="form1" action="/admin/gallery/add" method="POST" enctype="multipart/form-data">
    <section id="artwork-section" style="position: relative;">
        <div class="image-container">
            <img src="/assets/icons/artwork-icon.svg" alt="Картина" class="artwork" id="artwork">
    ...
    <section id="description-section">
        <div class="description-container">
            <div class="description" style="margin-right: 30px">
                ...
                <textarea rows="10" name="description" style="width: 100%; font-size: 18px; padding: 10px; border: 1px solid #ccc; border-radius: 4px; background-color: #f9f9f9; "></textarea>
            </div>
            ...
            <div class="description">
                ...
                <ul class="characteristics-list">
                    ...
                    <li>
                        <label for="author">Номер автора:</label>
                    ...
                    <li>
                        ...
                        <input type="text" id="yearOfCreation" name="yearOfCreation">
                    </li>
                    <li>
